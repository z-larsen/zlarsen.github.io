...
<figure>
  <img src="/assets/img/csaagent.png" alt="Azure CSA Agent CLI showing the interactive REPL with ASCII art banner, sample natural language prompts, and rotating greeting">
